...
def updateV(V, T, f):
    for t in T:
        ...
        V[t[2]][t[1]][0] -= f * sgn
        V[t[2]][t[1]][1] += f * sgn
V = [[[0,0,1], [9,0,1], [0,0,1], [12,0,-1], [0,0,1], [9,0,-1]],
     [[9,0,-1], [0,0,1], [15,0,-1], [11,0,-1], [8,0,1], [0,0,1]],
     [[0,0,1], [15,0,1], [0,0,1], [10,0,1], [10,0,1], [14,0,-1]],
     [[12,0,1], [11,0,1], [10,0,-1], [0,0,1], [11,0,-1], [15,0,-1]],
     [[0,0,1], [8,0,-1], [10,0,-1], [11,0,1], [0,0,1], [13,0,-1]],
     [[9,0,1], [0,0,1], [14,0,1], [15,0,1], [13,0,1], [0,0,1]]
]
N = len(V)  # число вершин в графе
init = 5    # вершина истока (нумерация с нуля)
end = 1     # вершина стока
